...
ActorBase Property AutomatronActorBase Auto
...
int Function GetNameIndex(Actor npc, Bool assign = false)
	...
	elseif (base == TweakCompanionNate)
		targetid = 17
	elseif (  base ==  (Game.GetFormFromFile(0x00001002, "ellen.esp") as ActorBase) )
		targetid = 69
	elseif (  base ==  (Game.GetFormFromFile(0x00000803, "CompanionIvy.esm") as ActorBase) )
		targetid = 94
...
Bool Function AssignName(Actor npc, int id)
	...
	if (id > 50)
		...
		if npc.getActorBase() == AutomatronActorBase
			return true
		endif
