...
Scriptname AFT:Fragments:Terminals:TERM_TweakPoseSelectTerminal_010225EF Extends Terminal Hidden Const
...
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(0)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(1)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(2)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(3)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(4)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(5)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(6)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(7)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(8)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(9)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(10)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(11)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(12)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(13)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(14)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(15)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(16)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(17)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(18)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(19)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(20)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(21)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(22)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(23)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(24)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(25)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(26)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(27)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(28)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(29)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(30)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(31)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(32)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(33)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(34)
endif
;END CODE
EndFunction
;END FRAGMENT
...
AFT:TweakPipBoyScript pTweakPipBoyScript = (pTweakPipBoy as AFT:TweakPipBoyScript)
if (pTweakPipBoyScript)
    pTweakPipBoyScript.PoseRelay(35)
endif
;END CODE
EndFunction
;END FRAGMENT
