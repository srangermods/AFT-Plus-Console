...
Scriptname AFT:Fragments:Terminals:TERM_TweakAFTSettingsTermi_0100DE0D_2 Extends Terminal Hidden
...
;BEGIN CODE
pTweakCharismaRecruitLimit.SetValueInt(1)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
pTweakCharismaRecruitLimit.SetValueInt(0)
;END CODE
EndFunction
;END FRAGMENT
...
GlobalVariable Property pTweakCharismaRecruitLimit Auto