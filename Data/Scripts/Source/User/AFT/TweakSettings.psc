...
Function initialize()
	...
	elseif (base == Game.GetForm(0x00027683) as ActorBase) ; 4 ---=== Danse ===---
		...
		Quest BoS302 = Game.GetForm(0x000B9F9D) as Quest ; Blind Betrayal
		if BoS302.isActive() || Bos302.isCompleted()
			originalHome = Game.GetForm(0x000D10A8) as Location ; Listening Post Bravo
			ObjectReference BoS302DanseMarker = Game.getForm(0x000D109D) as ObjectReference
			originalHomeRef = BoS302DanseMarker
		elseif BoS201 && BoS201.GetStageDone(90)
