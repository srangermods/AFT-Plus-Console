...
Quest       Property pTweakNukaInterjections Auto Const
Quest       Property pTweakFarHarborInterjections Auto Const
...
Function OnGameLoaded()
	...
	AFT:TweakInterjectionNukaQuestScript pTweakInterjectionNukaQuestScript = pTweakNukaInterjections as AFT:TweakInterjectionNukaQuestScript
	if pTweakInterjectionNukaQuestScript
		pTweakInterjectionNukaQuestScript.OnGameLoaded(firstCall)
	else
		Trace("Unable to Call pTweakInterjectionNukaQuestScript.OnGameLoaded()")	
	endif
	AFT:TweakInterjectionFarHarborQuestScript pTweakInterjectionFarHarborQuestScript = pTweakFarHarborInterjections as AFT:TweakInterjectionFarHarborQuestScript
	if pTweakInterjectionFarHarborQuestScript
		pTweakInterjectionFarHarborQuestScript.OnGameLoaded(firstCall)
	else
